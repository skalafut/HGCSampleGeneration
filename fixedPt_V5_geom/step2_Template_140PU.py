...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step1_chargedPiGun_PtmeanEn_NUM_100evts.root')
)
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step2_chargedPiGun_PtmeanEn_140PU_NUM_100evts.root'),
...
process.mix.input.fileNames = cms.untracked.vstring(['file:MinBias_14TeV_HGCV5_1000evts.root'])
