...
# with command line options: step3 --conditions auto:upgradePLS3 -n 50 --eventcontent FEVTDEBUGHLT -s RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023HGCalMuon --geometry Extended2023HGCalMuon,Extended2023HGCalMuonReco --magField 38T_PostLS1 --filein file:step2_chgdPionGun_EmeanEn_EtareplaceEta_140PU_NUM_50evts.root --fileout file:step3_chgdPionGun_EmeanEn_EtareplaceEta_140PU_NUM_50evts.root --pileup AVE_140_BX_25ns --pileup_input file:MinBias_14TeV_HGCV5_1000evts.root --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step2_chgdPionGun_EmeanEn_EtareplaceEta_140PU_NUM_30evts.root')
)
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = process.FEVTDEBUGHLTEventContent.outputCommands + cms.untracked.vstring('keep *_particleFlowRecHit*_*_*'),
    fileName = cms.untracked.string('file:step3_chgdPionGun_EmeanEn_EtareplaceEta_140PU_NUM_30evts.root'),
