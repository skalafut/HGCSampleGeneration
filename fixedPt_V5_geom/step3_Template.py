...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step2_chargedPiGun_PtmeanEn_NoPU_NUM_100evts.root')
)
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = process.FEVTDEBUGHLTEventContent.outputCommands + cms.untracked.vstring('keep *_particleFlowRecHitHGC*_*_*'),
    fileName = cms.untracked.string('file:step3_chargedPiGun_PtmeanEn_NoPU_NUM_100evts.root'),
